...
total_qtr_long = pd.melt(total_qtr, id_vars=['state', 'drugtype', 'temporal_unit', 'date'],
        value_vars = ['imprx', 'adjmedamt', 'percap_rx', 'percap_adjmedamt'],
        var_name = 'metric')
...
total_qtr_long.replace({'metric': 'imprx'}, 'rx', inplace = True)
...
total_yr_long.replace({'metric': 'imprx'}, 'rx', inplace = True)
...
generic_brand_yr_long.replace({'metric': 'imprx'}, 'rx', inplace = True)
